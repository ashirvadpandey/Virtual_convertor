...
def textconver():
    ...
    # ==========================================AWS=============================================================
                ...
                try:
                    ...
                    s3 = boto3.resource("s3",aws_access_key_id='AKIA3TBXVLIMK5GDUQ7Q', aws_secret_access_key='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',region_name="us-east-1",)
                    print('login k niche')
                    ...
                    if(formate_of_file == '.pdf'):
                        ...
                        if(len(emaillist)!=0):
                            ...
                            s3.meta.client.upload_file(formated_file,'virtualconvertor',f'Text:{d}{t}.pdf')
                ...
                #========================AWS Link Generate==============
                            ...
                            s3 = boto3.resource( 
                                "s3",
                                aws_access_key_id='AKIA3TBXVLIMK5GDUQ7Q', 
                                aws_secret_access_key='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',
                                region_name="us-east-1",
                                )
                            url='https://virtualconvertor.s3.us-east-1.amazonaws.com/'+c
                        ...
                        print(formated_file)
                        if(len(emaillist)!=0):
                            s3.meta.client.upload_file(formated_file,'virtualconvertor',f'Text:{d}{t}.docx')
                ...
                #========================AWS Link Generate==============
                        ...
                        print("Under txt")
                        if(len(emaillist)!=0):
                            s3.meta.client.upload_file('random2.txt','virtualconvertor',f'Text:{d}{t}.txt')
...
# Dropdown menu options
    ...
    labeltext=Label(root,text='All right reserved to Bug Aches \xa9 2022',width=130, font="Bold", foreground="#212529")
